...
async def health_geospatial():
    ...
    return {
        ...
        "llm": {"configured": bool(s.llm_configured), "status": llm_st, "providers": ["Gemini","Groq"], "model": "gemini-3.6-flash / groq/compound-mini", "capability": "PCCC scenario generation", "last_success": now if llm_st=="LIVE" else None, "cache_status": "LIVE" if llm_st=="LIVE" else ("DEMO" if llm_st=="DEMO" else None)},
